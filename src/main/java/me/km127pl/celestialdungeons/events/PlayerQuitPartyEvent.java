...
public class PlayerQuitPartyEvent extends Event {
	...
	public PlayerQuitPartyEvent(Player player, PartyManager.Party party) {
		this.player = player;
		this.party = party;
	}
	...
	public static void fire(Player player, PartyManager.Party party) {
		Bukkit.getPluginManager().callEvent(new PlayerQuitPartyEvent(player, party));
	}
}
